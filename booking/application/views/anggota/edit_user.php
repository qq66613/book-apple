                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="">Update Data User Booking</a>
                                </li>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card card-primary">
                                ...
                                <!-- /.card-header -->
                                <!-- form start -->
                                <form method="POST" action="<?= base_url()?>anggota_dashboard/update">
                                    <div class="card-body">
                                        <div class="form-group">
                                            <label for="iduser1">ID User</label>
                                            <input type="text" class="form-control" name="iduser1"
                                                value="<?= $data['id_user']?>" id="iduser1" readonly>
                                        </div>
                                        <div class="form-group">
                                            <label for="inputuser1">Nama User</label>
                                            <input type="text" class="form-control" id="namauser1" name="namauser1"
                                                value="<?= $data['nama_user']?>" placeholder="Enter Nama User" required>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="tel" class="form-control" id="no_telp" name="no_telp"
                                                placeholder="Enter No Telp" value="<?= $data['no_telepon']?>" required>
                                        </div>
                                        <div class="form-group">
                                            <label for="inputnoktp">No KTP/Number ID Card </label>
                                            <input type="text" class="form-control" id="no_ktp" name="no_ktp"
                                                placeholder="Enter No KTP/Id Card" value="<?= $data['no_ktp']?>"
