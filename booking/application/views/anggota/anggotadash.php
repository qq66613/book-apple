                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="<?= base_url('anggota_dashboard')?>">Data User
                                        Booking</a>
                                </li>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="tambah-2">
                                <div class="col-mt-20">
                                    <a href="<?= base_url()?>anggota_dashboard/tambah">
                                    ...
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><?= $row->no_ktp?></td>
                                                <td>
                                                    <a href="<?= base_url()?>anggota_dashboard/edit/<?= $row->id_user?>"
                                                        class="btn btn-primary btn-xs">edit</a>
                                                    <a href="<?= base_url()?>anggota_dashboard/delete/<?= $row->id_user?>"
