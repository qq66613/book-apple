        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Update Tipe Device</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="">Update Data Tipe Device</a>
                                </li>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card card-primary">
                                <div class="card-header">
                                    <h3 class="card-title">Input Tipe Device</h3>
                                </div>
                                <!-- /.card-header -->
                                <!-- form start -->
                                <form method="POST" action="<?= base_url()?>tipe_device/update">
                                    <div class="card-body">
                                        <div class="form-group">
                                            <label for="iduser1">ID User</label>
                                            <input type="text" class="form-control" name="jenisdevice"
                                                value="<?= $data['id_jenis_device']?>" id="jenisdevice" readonly>
                                        </div>
                                        <div class="form-group">
                                            <label for="inputuser1">Nama User</label>
                                            <input type="text" class="form-control" id="namauser1" name="typedevice"
                                                value="<?= $data['jenis_device']?>" placeholder="Enter Nama User"
                                                required>
                                        </div>
                                        <div class="form-group">
                                            <label for="typedevice">Type Device</label>
                                            <input type="number" class="form-control" id="jumlah" name="jumlah"
                                                placeholder="jumlah Device" value="<?= $data['jumlah']?>" required>
