        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">List Device</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="<?= base_url()?>tipe_device">List Device</a>
                                </li>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="tambah-2">
                                <div class="col-mt-20">
                                    <a href="<?= base_url()?>tipe_device/tambah">
                                ...
                                <div class="card-body">
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td><?= $row->id_jenis_device?></td>
                                                <td><?= $row->jenis_device?></td>
                                                <td><?= $row->jumlah?></td>
                                                <td>
                                                    <a href="<?= base_url()?>tipe_device/edit/<?= $row->id_jenis_device?>"
                                                        class="btn btn-primary btn-xs">edit</a>
                                                    <a href="<?= base_url()?>tipe_device/delete/<?= $row->id_jenis_device?>"
