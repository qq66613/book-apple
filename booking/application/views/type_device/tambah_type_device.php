                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="<?= base_url()?>tipe_device/tambah">Tambah Type
                                        device
                                    </a>
                                </li>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card card-primary">
                                ...
                                <!----value=""---->
                                <!-- form start -->
                                <form method="POST" action="<?= base_url()?>tipe_device/simpan">
                                    <div class="card-body">
                                        <!--<div class="form-group">
                                            <label for="iduser1">ID User</label>
                                            <input type="text" class="form-control" name="iduser1" id="iduser1"
                                                readonly>
                                        </div>-->
                                        <div class="form-group">
                                            <label for="typedevice">Type Device</label>
                                            <input type="text" class="form-control" id="typedevice" name="typedevice"
                                                placeholder="Enter Tipe Device" required>
                                        </div>
                                        <div class="form-group">
                                            <label for="typedevice">Jumlah Device</label>
                                            <input type="number" class="form-control" id="jumlah" name="jumlah"
                                                placeholder="jumlah Device" required>
                                        </div>
                                        <!--</div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="no_ktp" name="no_ktp"
                                                placeholder="Enter No KTP/Id Card" maxlength="16" minlength="16"
                                                required>
                                        </div>-->
                                        <!--<div class="form-group">
                                    ...
                                    <div class="card-footer">
                                        <div class="text-right">
                                            <a href="<?= base_url()?>tipe_device" class="btn btn-danger">Cancel</a>
