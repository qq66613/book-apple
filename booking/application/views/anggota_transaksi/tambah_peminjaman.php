                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="<?= base_url()?>anggota_peminjaman/tambah">Tambah
                                        List
                                        Peminajaman
                                    </a>
                                </li>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card card-primary">
                                ...
                                <!----value=""---->
                                <!-- form start -->
                                <form method="POST" action="<?= base_url()?>anggota_peminjaman/simpan"
                                    ...
                                    <div class="card-footer">
                                        <div class="text-right">
                                            <a href="<?= base_url()?>anggota_peminjaman"
