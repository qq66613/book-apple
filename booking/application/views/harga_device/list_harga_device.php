        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Lis Harga Device</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="<?= base_url()?>harga_device">List Harga Device</a>
                                </li>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="tambah-2">
                                <div class="col-mt-20">
                                    <a href="<?= base_url()?>harga_device/tambah">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            <?php 
                                            foreach($this->db->get('hargadevice')->result() as $row) {?>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="<?= base_url()?>harga_device/edit/<?= $row->idharga?>"
                                                        class="btn btn-primary btn-xs">edit</a>
                                                    <a href="<?= base_url()?>harga_device/delete/<?= $row->idharga?>"
