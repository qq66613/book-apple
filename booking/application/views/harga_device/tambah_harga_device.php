                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card card-primary">
                                ...
                                <!----value=""---->
                                <!-- form start -->
                                <form method="POST" action="<?= base_url()?>harga_device/simpan">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            <label for="typedevice">Harga Type Device</label>
                                            <input type="number" class="form-control" id="hargadevice"
                                                name="hargadevice" placeholder="Enter Harga Device" minlength="10"
                                                required>
                                        </div>
                                        <!--</div>
                                        <div class="form-group">
