        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Update harga tipe Device</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="">Update harga tipe Device</a>
                                </li>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card card-primary">
                                <div class="card-header">
                                    <h3 class="card-title">Input Harga Device</h3>
                                </div>
                                <!-- /.card-header -->
                                <!-- form start -->
                                <form method="POST" action="<?= base_url()?>harga_device/update">
                                    <div class="card-body">
                                        <div class="form-group">
                                            <label for="iduser1">ID Harga</label>
                                            <input type="text" class="form-control" name="idhargadevice"
                                                value="<?= $data['idharga']?>" id="jenisdevice" readonly>
                                        </div>
                                        <div class="form-group">
                                            <label for="inputuser1">Harga Device</label>
                                            <input type="number" class="form-control" id="namauser1" name="hargadevice"
                                                value="<?= $data['hargadev']?>" placeholder="Enter Harga Barang"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="tel" class="form-control" id="no_telp" name="no_telp"
                                                placeholder="Enter No Telp" value="" required>
                                        </div>
                                        <div class="form-group">
                                            <label for="inputnoktp">No KTP/Number ID Card </label>
                                            <input type="text" class="form-control" id="no_ktp" name="no_ktp"
                                                placeholder="Enter No KTP/Id Card" value=""
                                    ...
                                    <div class="card-footer">
                                        <div class="text-right">
                                            <a href="<?= base_url()?>harga_device" class="btn btn-danger">Cancel</a>
