        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Edit Data Device</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="">Edit data
                                        device
                                    </a>
                                </li>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card card-primary">
                                <div class="card-header">
                                    <h3 class="card-title">Edit Data Device</h3>
                                </div>
                                <!-- /.card-header -->
                                <!----value=""---->

                                <!-- form start -->
                                <form method="POST" action="<?= base_url().'nama_barang/update';?>"
                                    enctype="multipart/form-data">
                                    <div class="card-body">
                                        <div class="form-group">
                                            <label for="iduser1">SKU Barang</label>
                                            <input type="text" class="form-control" name="skubarang" id="skubarang"
                                                value="<?=$data['skubarang']?>" readonly>
                                        </div>
                                        <div class="form-group">
                                            <label for="namabarangdevice">Nama Device</label>
                                            <input type="text" class="form-control" id="namabarangdevice"
                                                name="namabarangdevice" placeholder="Enter nama barang Device"
                                                value="<?=$data['namabarangdevice']?>" required>
                                        </div>
                                        <div class="form-group">
                                            <label for="inputemail">SN Device</label>
                                            <input type="text" class="form-control" id="sndevice" name="sndevice"
                                                placeholder="SN Device" value="<?=$data['snbarang']?>" required>
                                        </div>
                                        <!--<div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <label for="gender">Type Device</label>
                                            <div>
                                                <select name="id_jenis_device" class="form-control" required>
                                                    <option>- Pilih Jenis Device -</option>
                                                    <?php 
                                                        foreach ($this->db->get('sewa_barang')->result() as $row){
                                                            if($data['id_jenis_device'] == $row->id_jenis_device)
                                                        {?>
                                                    <option value="<?= $row->id_jenis_device;?>" selected>
                                                        <?= $row->jenis_device;?>
                                                    </option>
                                                    <?php }else{?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-16">
                                                <select name="idharga" class="form-control select2bs4" required>
                                                    <option class="option">- Pilih Harga -</option>
                                                    <?php foreach ($this->db->get('hargadevice')->result() as $row){
                                                        if($data['idharga'] == $row->idharga)
                                                    {?>
                                                    <option value="<?=$row->idharga;?>" selected>
                                                        <?= $row->hargadev;?>
                                                    </option>
                                                    <?php }else{?>
                                                    <option value="<?=$row->idharga;?>">
                                                        <?= $row->hargadev;?>
                                                    </option>
                                                    <?php }
                                                    }
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-16">
                                                <select name="tahunbarang" class="form-control select2bs4" required>
                                                    <option class="option">- Pilih Tahun -</option>
                                                    <?php
                                                    for($tahun = 2000;$tahun<=2060; $tahun++){
                                                        if($data['tahun_barang'] == $tahun){?>
                                        ...
                                        <img src="<?= base_url('uploads/barang/' . $data['gambar']) ?>" width="100">

                                        <!-- Add a hidden input field to store the current image name -->
                                    ...
                                    <div class="card-footer">
                                        <div class="text-right">
                                            <a href="<?= base_url()?>nama_barang" class="btn btn-danger">Cancel</a>
