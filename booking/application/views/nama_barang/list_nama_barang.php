        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">List Nama Device</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="<?= base_url()?>nama_barang">List Nama Device</a>
                                </li>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="tambah-2">
                                <div class="col-mt-20">
                                    <a href="<?= base_url()?>nama_barang/tambah">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            <?php 
                                            foreach($this->m_barang->get_data_barang()->result() as $row) {?>
                                            ...
                                            <tr>
                                                ...
                                                <td><img Style="Width: 50px; height:50px"
                                                        src="<?=base_url('uploads/barang/'.$row->gambar.'') ?>" />
                                                </td>



                                                <td>
                                                    <a href="<?= base_url()?>nama_barang/edit/<?= $row->skubarang?>"
                                                        class="btn btn-primary btn-xs">edit</a>
                                                    <a href="<?= base_url()?>nama_barang/delete/<?= $row->skubarang?>"
