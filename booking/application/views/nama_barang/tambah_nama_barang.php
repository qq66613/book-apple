        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Input Type Device</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="<?= base_url()?>Harga_device/tambah">Tambah Harga
                                        device
                                    </a>
                                </li>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card card-primary">
                                <div class="card-header">
                                    <h3 class="card-title">Input Type Device</h3>
                                </div>
                                <!-- /.card-header -->
                                <!----value=""---->
                                <!-- form start -->
                                <form method="POST" action="<?= base_url()?>nama_barang/simpan"
                                    enctype="multipart/form-data">
                                    <div class="card-body">
                                        <div class="form-group">
                                            <label for="iduser1">SKU Barang</label>
                                            <input type="text" class="form-control" name="skubarang" id="skubarang"
                                                value="<?=  $this->m_barang->skubarang();?>" readonly>
                                        </div>
                                        <div class="form-group">
